...
Payment method distribution is evenly split:
...
Customer behavior indicates no heavy dependency on a single payment channel, reflecting flexible payment adoption.
...
Profit trend by Year, Quarter, Month, and Day

Revenue & profit comparison by product line
...
Monitor financial performance using quantitative KPIs

Identify profitable product categories

Optimize promotion timing based on profit volatility

Improve customer experience through rating analysis
